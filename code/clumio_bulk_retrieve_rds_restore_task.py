...
"""Lambda function to retrieve the RDS restore task."""
...
def lambda_handler(events: EventsTypeDef, context: LambdaContext) -> dict[str, Any]:
    """Handle the lambda function to retrieve the RDS restore task."""
    ...
    resource_id: str | None = events.get('inputs', {}).get('source_resource_id', None)
